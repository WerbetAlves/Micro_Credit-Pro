...
import { getInstallmentDisplayStatus, isReceivableInstallment } from '../lib/installments';
...
export function Calendar() {
  ...
  const monthReceivableTotal = installments
    ...
    .filter((inst) => isReceivableInstallment(inst))
                      ...
                      <div className="mt-3 space-y-1">
                        {dayInsts.slice(0, 3).map((inst, i) => (
                          <div key={i} className={cn(
                            ...
                            getInstallmentDisplayStatus(inst) === 'paid'
                              ? "bg-emerald-50 text-emerald-600 border-emerald-100"
                              : getInstallmentDisplayStatus(inst) === 'late'
